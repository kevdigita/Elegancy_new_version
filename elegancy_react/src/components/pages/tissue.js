        ...
        return (
            <div className=" text-stone-600" key={items.id}>
                ...
                <div className="my-3">
                    ...
                    <p className="flex  md:space-x-44 my-1 ">
                        <span>{items.price} XOF</span>
                        <button className=" "> <img src="Elegency/heart.svg" alt=""></img></button>
                    </p>
                </div>
                <button className="bg-brun p-2 px-20 rounded text-white text-sm mt-2"> COMMANDER</button>
            </div>)
    });
    return (<div className=" lg:px-60 pt-20 px-20 md:px-10 z-40   pb-10">
        ...
        <div className="flex justify-between  my-4">
            <div className=""><button className="mr-4">Tous </button>
                <button className="m-4 z-40">Wax  </button>
                <button className="m-4 z-40">Vlisco</button>
                <button className="m-4 z-40">Occidental</button></div>
            <div className=" absolute right-44 top-32  ">
                <img src="Elegency/Ellipse6.svg "className=" lg:flex hidden relative " alt=""></img>
            </div>
        ...
        <section className=" relative grid md:grid-cols-3 gap-10"> {Card}</section>
